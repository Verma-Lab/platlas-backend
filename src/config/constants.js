...
// export const SQLITE_DB_PATH = "/Users/hritvik/genomics-backend/phewas_database.db";``
export const GWAMA_DB = "/nfs/platlas_stor/db/genomics-backend/phewas_gwama.db";``
export const MRMEGA_DB = "/nfs/platlas_stor/db/genomics-backend/phewas_mrmega.db";``
...
export const SNP_ANNOTATION_DB = '/nfs/platlas_stor/db/snp_annotations.db';
